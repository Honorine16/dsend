...
<body>
    ...
    <div class="auth-cover-form">
        <form action="/brief/processing/authentication.php" method="post">
            ...
            <p class="text-center">Renseigner les informations liées au compte que vous êtes sur le point de créer.</p>
            ...
            <?php if (isset($_GET['password']) && $_GET['password'] == "error") { ?>
                <div class="alert-error">
                    Les deux mots de passe saisis ne sont pas conformes.
                </div>
            <?php } ?>
